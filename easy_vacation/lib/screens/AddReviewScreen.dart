...
class _AddReviewScreenState extends State<AddReviewScreen> {
  ...
  void _showErrorDialog(BuildContext context, String errorMessage, AppLocalizations loc) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        backgroundColor: context.cardColor,
                ...
                builder: (context, state) {
                  ...
                  return Container(
                    ...
                    child: ElevatedButton(
                      onPressed: isLoading || (_rating == 0 || _reviewController.text.trim().isEmpty)
                          ? null
                          : () => _submitReview(context),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: isLoading || (_rating == 0 || _reviewController.text.trim().isEmpty)
